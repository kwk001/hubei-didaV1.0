...
name_chn: 品牌指南
description: 将 Anthropic 的官方品牌颜色和排版应用于任何可能受益于 Anthropic 外观和感觉的工件。当品牌颜色或样式指南、视觉格式化或公司设计标准适用时使用。
...
**关键词**: 品牌、企业形象、视觉识别、后处理、样式、品牌色、排版、Anthropic 品牌、视觉格式化、视觉设计
